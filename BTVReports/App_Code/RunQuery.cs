...
namespace RunQuery
{
    public class SQLQuery
    {
        ...
        public static void LoadrptHeader(XerpDataSet ds, ReportDocument rpt)
        {
            //For CrptHeader
            DataTable dtx2 = SQLQuery.ReturnDataTable(@"SELECT TOP (1) [CompanyID], [CompanyName], [MobileNo], [Email], [ProjectName], [CompanySpeciality], [CompanyAddress], [AuthorityName], (Select PhotoURL from Photos where PhotoID=Company.Logo) AS Logo, Photo  FROM [Company]");
