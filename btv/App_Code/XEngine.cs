...
public class XEngine
{
    ...
    public static string GenerateDropDown(string ddFieldName)
    {
        ...
        pageLayout += "     AutoPostBack=\"False\" OnSelectedIndexChanged=\"dd" + ddFieldName + "_SelectedIndexChanged\">" + Environment.NewLine;
    ...
    public static string GenerateCheckBox(string ddFieldName)
    {
        string pageLayout = "" + Environment.NewLine;
        pageLayout += "<tr>" + Environment.NewLine;
        pageLayout += "<td>" + NormalizeText(ddFieldName) + "</td>" + Environment.NewLine;
        pageLayout += "<td>" + Environment.NewLine;
        pageLayout += "<asp:CheckBox ID=\"cb" + ddFieldName.Replace(" ", "") + "\" runat=\"server\" " + Environment.NewLine;
        pageLayout += "     AutoPostBack=\"False\" OnCheckedChanged=\"dd" + ddFieldName + "_CheckedChanged\">" + Environment.NewLine;
    ...
    public static void SaveCSharpFile(string formName, string docPath, string pageLoad, string insertQuery, string updateQuery, string selectQuery, string deleteQuery, string editingControls, string clearControls, string gridSQL, string ddlEvents)
    {
        string pageLayout = "";
        pageLayout += @"
using System;
...
using RunQuery;" + Environment.NewLine;
        ...
        pageLayout += "{" + Environment.NewLine;
        //pageLayout += "if (txtAmount.Text != \"\")" + Environment.NewLine;
        //pageLayout += "{" + Environment.NewLine;
