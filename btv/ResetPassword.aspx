<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" Theme="Blue" AutoEventWireup="true" CodeFile="ResetPassword.aspx.cs" Inherits="ResetPassword" %>
                        ...
                        <table border="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="SubmitButton" runat="server" CommandName="Submit" OnClick="SubmitButton_Click" Text="Submit" 
