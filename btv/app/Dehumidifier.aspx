<%@ Page Title="Dehumidifier" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="Dehumidifier.aspx.cs" Inherits="app_Dehumidifier" %>
                        ...
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            <tr>
                                <td align="center" colspan="2">
                                    ...
                                    <asp:HiddenField runat="server" ID="hiddenDMID" />
                                    <asp:HiddenField runat="server" ID="hiddenDMVoucher" />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" InitialValue="0" ControlToValidate="ddLocationID" ValidationGroup="Save" runat="server" ErrorMessage="Select Main Office"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" InitialValue="0" ControlToValidate="ddLocationInMainOffice" ValidationGroup="Save" runat="server" ErrorMessage="Select Location In Main Office"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>Filter</td>
                                <td>
                                    <asp:DropDownList ID="ddlFilter" Width="100%" runat="server" CssClass="form-control select2me">
                            ...
                            <tr>
                                <td>Condition</td>
                                <td>
                                    <asp:DropDownList ID="ddlCondition" Width="100%" runat="server" CssClass="form-control select2me">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtRemarks" ValidationGroup="Save" runat="server" ErrorMessage="Enter Remarks"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                    ...
                    <fieldset>
                        ...
                        <div class="table-responsive">
                            <asp:GridView Width="160%" ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                                ...
                                GridLines="Vertical" DataKeyNames="DehumidifierId" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>.
                                            <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Bind("DehumidifierId") %>'></asp:Label>
                                            <asp:Label ID="lblEntryBy" runat="server" Visible="false" Text='<%# Bind("EntryBy") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="20px" HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="DM Number" SortExpression="DMVoucher">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" Width="120px" Target="_blank" NavigateUrl='<%#Eval("DehumidifierId") %>'>
                                                <asp:Label ID="lblDMNumber" runat="server" Text='<%# Bind("DMVoucher") %>'></asp:Label>
                                            </asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Workflow Details">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink" Width="110px" runat="server" Target="_blank" NavigateUrl='<%# "WorkFlowStatusForDehumidifier?id="+Eval("DehumidifierId") %>'>
