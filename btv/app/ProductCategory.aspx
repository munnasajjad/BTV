<%@ Page Title="Product Category" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="ProductCategory.aspx.cs" Inherits="app_ProductCategory" %>
                ...
                <section class="panel">
                    <fieldset>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                            ...
                            GridLines="Vertical" DataKeyNames="ProductCategoryID" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
                            <Columns>

                                <asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
                                    <ItemTemplate>
                                        <%#Container.DataItemIndex+1 %>.
                                        <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Bind("ProductCategoryID") %>'></asp:Label>
                                    </ItemTemplate>
