<%@ Page Title="Menu Group" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="MenuGroup.aspx.cs" Inherits="app_MenuGroup" %>
                ...
                <section class="panel">
                    ...
                    <fieldset>
                        ...
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            ...
                            <tr>
                                <td>Desplay Serial</td>
                                <td>
                                    <asp:TextBox ID="txtDesplaySerial" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="ftbDesplaySerial" runat="server" FilterType="Numbers" ValidChars="0123456789" TargetControlID="txtDesplaySerial" />
                                    <asp:RequiredFieldValidator ID="rfvDesplaySerial" ControlToValidate="txtDesplaySerial" Display="Dynamic" SetFocusOnError="True" runat="server" ErrorMessage="Enter Desplay Serial field " Style="margin-left: 30%"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Icon Class</td>
                                <td>
                                    <asp:DropDownList ID="ddIconClass" runat="server" CssClass="form-control select2me"
                                        AutoPostBack="False" OnSelectedIndexChanged="ddIconClass_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                ...
                <section class="panel">
                    <fieldset>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                            ...
                            GridLines="Vertical" DataKeyNames="Sl" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
                            <Columns>

                                <asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
                                    <ItemTemplate>
                                        <%#Container.DataItemIndex+1 %>.
                                        <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Bind("Sl") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="20px" HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="GroupName" HeaderText="Group Name" SortExpression="GroupName" />
                                <asp:BoundField DataField="DesplaySerial" HeaderText="Desplay Serial" SortExpression="DesplaySerial" />
                                <asp:BoundField DataField="Show" HeaderText="Show" SortExpression="Show" />
                                <asp:BoundField DataField="IconClass" HeaderText="Icon Class" SortExpression="IconClass" />
