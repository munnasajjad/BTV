<%@ Page Title="Work Flow Status For Maintenance" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="WorkFlowStatusForMaintenance.aspx.cs" Inherits="app_WorkFlowStatusForMaintenance" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <fieldset>
                            <div class="caption">
                                <legend>Maintenance Voucher Information</legend>
                            </div>
                            <div class="portlet-body">
                                ...
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    ...
                                    <div class="col-md-4">
                                        <label>MN Number:</label>
                                        <asp:Label ID="txtMNNumber" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-4">
                                        <label>User:</label>
                                ...
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    ...
                                    <div class="col-md-4">
                                        <label>Problem Occurred Place:</label>
                                        <asp:Label ID="txtProblemOccurredPlace" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-4">

                                        <label>Type of Problem:</label>
                                        <asp:Label ID="txtTypeOfProblem" runat="server"></asp:Label>
                                ...
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    <div class="col-md-4">
                                        ...
                                        <label>Solution Provided By:</label>
                                        <asp:Label ID="txtSolutionProvidedBy" runat="server"></asp:Label>
