<%@ Page Title="Work Flow Status For Daily Maintenance" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="WorkflowStatusForDailyMaintenance.aspx.cs" Inherits="app_WorkflowStatusForDailyMaintenance" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <fieldset>
                            <div class="caption">
                                <legend>Daily Maintenance of Split AC Information</legend>
                            </div>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <label>AH No:</label>
                                                <asp:Label ID="txtDMNNo" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                ...
                                                <asp:Label ID="txtNameoftheBrand" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <label>Capacity of Split:</label>
                                                <asp:Label ID="txtCapacityofSplit" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="control-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                ...
                                                <asp:Label ID="txtPresentCondition" runat="server"></asp:Label>
                                            </div>
                                    ...
                                    <asp:GridView runat="server" Width="100%" ShowFooter="True" ID="workInfoGridView" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" BackColor="White" BorderColor="#DEDFDE" GridLines="Vertical">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Date" SortExpression="CrID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="labelAHUId" runat="server" Visible="False" Text='<%# Bind("DailyMaintenanceDetailsID") %>'></asp:Label>
