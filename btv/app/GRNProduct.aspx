<%@ Page Title="G R N Product" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="GRNProduct.aspx.cs" Inherits="app_GRNProduct" %>
...
<td>G R N No</td>
<td>
<asp:DropDownList ID="ddGRNNo" runat="server" CssClass="form-control select2me"
     AutoPostBack="False" OnSelectedIndexChanged="ddGRNNo_SelectedIndexChanged">
</asp:DropDownList>
</td>
</tr>
...
<asp:FilteredTextBoxExtender ID="ftbUnitNumber" runat="server" FilterType="Numbers" ValidChars="0123456789" TargetControlID="txtUnitNumber" />
</td>
</tr>
...
<td>
<asp:TextBox ID="txtReceiveProduct" runat="server" CssClass="form-control"></asp:TextBox>
</td>
</tr>
...
<td>
<asp:TextBox ID="txtProductMfgDate" runat="server" CssClass="form-control"></asp:TextBox>
<asp:CalendarExtender ID="ceProductMfgDate" runat="server" Format="dd/MM/yyyy" TargetControlID="txtProductMfgDate" />
</td>
</tr>
...
<td>
<asp:TextBox ID="txtProductExpDate" runat="server" CssClass="form-control"></asp:TextBox>
<asp:CalendarExtender ID="ceProductExpDate" runat="server" Format="dd/MM/yyyy" TargetControlID="txtProductExpDate" />
</td>
</tr>
...
<asp:FilteredTextBoxExtender ID="ftbOtherCost" runat="server" FilterType="Custom, Numbers" ValidChars=".0123456789" TargetControlID="txtOtherCost" />
</td>
</tr>
...
<asp:GridView width="320%" ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
    ...
    GridLines="Vertical" DataKeyNames="GRNProductID" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
<Columns>

<asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
<ItemTemplate>
<%#Container.DataItemIndex+1 %>.
<asp:Label ID="Label1" runat="server" visible="false" Text='<%# Bind("GRNProductID") %>'></asp:Label>
</ItemTemplate>
<ItemStyle Width="20px" HorizontalAlign="Center" />
</asp:TemplateField>
<asp:BoundField DataField="ProductID" HeaderText="Product I D" SortExpression="ProductID" /><asp:BoundField DataField="GRNNo" HeaderText="G R N No" SortExpression="GRNNo" /><asp:BoundField DataField="ProductDescription" HeaderText="Product Description" SortExpression="ProductDescription" /><asp:BoundField DataField="UnitNumber" HeaderText="Unit Number" SortExpression="UnitNumber" /><asp:BoundField DataField="Less" HeaderText="Less" SortExpression="Less" /><asp:BoundField DataField="More" HeaderText="More" SortExpression="More" /><asp:BoundField DataField="ReceiveProduct" HeaderText="Receive Product" SortExpression="ReceiveProduct" /><asp:BoundField DataField="RejectProduct" HeaderText="Reject Product" SortExpression="RejectProduct" /><asp:BoundField DataField="ProductMfgDate" HeaderText="Product Mfg Date" SortExpression="ProductMfgDate" /><asp:BoundField DataField="ProductExpDate" HeaderText="Product Exp Date" SortExpression="ProductExpDate" /><asp:BoundField DataField="PriceLetterNo" HeaderText="Price Letter No" SortExpression="PriceLetterNo" /><asp:BoundField DataField="UnitPrice" HeaderText="Unit Price" SortExpression="UnitPrice" /><asp:BoundField DataField="TotalPrice" HeaderText="Total Price" SortExpression="TotalPrice" /><asp:BoundField DataField="OtherCost" HeaderText="Other Cost" SortExpression="OtherCost" /><asp:BoundField DataField="TotalCost" HeaderText="Total Cost" SortExpression="TotalCost" />
