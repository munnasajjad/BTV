<%@ Page Title="Live Broadcasting Source" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LiveBroadcastingSource.aspx.cs" Inherits="app_LiveBroadcastingSource" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-lg-6">
                <section class="panel">
                    ...
                    <fieldset>
                        <legend>Live Broadcasting Source</legend>
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            ...
                            <tr>
                                <td>Live Broadcasting Source<span class="required">*</span></td>
                                <td>
                    ...
                    <fieldset>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LiveBroadcastingSourceName" HeaderText="Source Name" SortExpression="SourceName" />
