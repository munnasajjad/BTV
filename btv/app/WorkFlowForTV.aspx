<%@ Page Title="WorkFlow For TV" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="WorkFlowForTV.aspx.cs" Inherits="app_WorkFlowForTV" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <fieldset>
                            <div class="caption">
                                <legend>TV Infoformation</legend>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <label>Date of TV:</label>
                                                <asp:Label ID="txtTVDate" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <label>TV No:</label>
                                                <asp:Label ID="txtTVNo" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                ...
                                                <asp:Label ID="txtStoreTo" runat="server"></asp:Label>
                                            </div>
                                        </div>
                        ...
                        <fieldset>
                            ...
                            <div class="col-lg-12">
                                 <div class="table-responsive">
                                            <asp:GridView runat="server" Width="100%" ID="productAddGridView" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" BackColor="White" BorderColor="#DEDFDE" GridLines="Vertical" >
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Sl." SortExpression="CrID" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblGRNProductID" runat="server" Text='<%# Bind("TvProductID") %>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Product Quantity" SortExpression="ReceiveProduct">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblReceiveProduct" runat="server" Text='<%# Bind("TvQty") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
