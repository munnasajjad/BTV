<%@ Page Title="Meter Reading" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="MeterReading.aspx.cs" Inherits="app_MeterReading" %>
                        ...
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            <tr>
                                <td align="center" colspan="2">
                                    ...
                                    <asp:HiddenField runat="server" ID="hiddenMRID" />
                                    <asp:HiddenField runat="server" ID="hiddenMRVoucher" />
                            ...
                            <tr>
                                <td>Date<span class="required">*</td>
                                <td>
                            ...
                            <tr>
                                <td>MR Number</td>
                                <td>
                                    <asp:TextBox ID="txtMRNumber" ReadOnly="True" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            <tr>
                                <td>Supplied By</td>
                                <td>
                                    <asp:DropDownList ID="ddlSupplied" Width="100%" CssClass="form-control select2me" runat="server">
                                        <asp:ListItem>DESCO</asp:ListItem>
                                        <asp:ListItem>DPDC</asp:ListItem>
                                    </asp:DropDownList>
                                    <%--<asp:TextBox ID="txtSuppliedBy" runat="server" CssClass="form-control"></asp:TextBox>--%>
                                </td>
                            </tr>


                            <tr>
                                <td>Meter Number<span class="required">*</td>
                                <td>
                                    <asp:TextBox ID="txtMeterNumber" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtMeterNumber" ValidationGroup="Save" runat="server" ErrorMessage="Enter Meter Number"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlConsumptionTime" Width="100%" CssClass="form-control select2me" runat="server">
                                        <asp:ListItem>Peak Hour</asp:ListItem>
                                        <asp:ListItem>Off Peak Hour</asp:ListItem>
                                    </asp:DropDownList>
                                    <%--<asp:TextBox ID="txtConsumptionTime" runat="server" CssClass="form-control"></asp:TextBox>--%>
                                </td>
                            </tr>


                            <tr>
                                <td>KVARH<span class="required">*</td>
                                <td>
                                    <asp:TextBox ID="txtKVARH" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtKVARH" ValidationGroup="Save" runat="server" ErrorMessage="Enter KVARH"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>Maximum Demand<span class="required">*</td>
                                <td>
                                    <asp:TextBox ID="txtMaximumDemand" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtMaximumDemand" ValidationGroup="Save" runat="server" ErrorMessage="Enter Maximum Demand"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>UHI Condition(C/F)<span class="required">*</td>
                                <td>
                                    <asp:TextBox ID="txtUHICondition" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtUHICondition" ValidationGroup="Save" runat="server" ErrorMessage="Enter UHI Condition(C/F)"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>1C(Peak)Columb per Hr<span class="required">*</td>
                                <td>
                                    <asp:TextBox ID="txt1CPeak" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txt1CPeak" ValidationGroup="Save" runat="server" ErrorMessage="Enter 1C(Peak)Columb per Hr"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>2C(Peak) Columb per Hr<span class="required">*</td>
                                <td>
                                    <asp:TextBox ID="txt2CPeak" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txt2CPeak" ValidationGroup="Save" runat="server" ErrorMessage="Enter 2C(Peak) Columb per Hr"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>Reading Taken By<span class="required">*</td>
                                <td>
                                    <asp:TextBox ID="txtReadingTakenBy" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtReadingTakenBy" ValidationGroup="Save" runat="server" ErrorMessage="Enter Reading Taken By"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtRemarks" ValidationGroup="Save" runat="server" ErrorMessage="Enter Remarks"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                    ...
                    <fieldset>
                        ...
                        <div class="table-responsive">
                            <asp:GridView Width="240%" ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                                ...
                                GridLines="Vertical" DataKeyNames="MeterReadingId" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>.
                                            <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Bind("MeterReadingId") %>'></asp:Label>
                                            <asp:Label ID="lblEntryBy" runat="server" Visible="false" Text='<%# Bind("EntryBy") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="20px" HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="MR Number" SortExpression="MRVoucher">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" Width="120px" Target="_blank" NavigateUrl='<%#Eval("MeterReadingId") %>'>
                                                <asp:Label ID="lblMRNumber" runat="server" Text='<%# Bind("MRVoucher") %>'></asp:Label>
                                            </asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Workflow Details">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink" Width="110px" runat="server" Target="_blank" NavigateUrl='<%# "WorkFlowStatusForMeterReading?id="+Eval("MeterReadingId") %>'>
                                    ...
                                    <asp:BoundField DataField="SuppliedBy" HeaderText="Supplied By" SortExpression="SuppliedBy" />
                                    <asp:BoundField DataField="MeterNumber" HeaderText="Meter Number" SortExpression="MeterNumber" />
                                    <asp:BoundField DataField="ConsumptionTime" HeaderText="Consumption Time" SortExpression="ConsumptionTime" />
                                    <asp:BoundField DataField="KVARH" HeaderText="KVARH" SortExpression="KVARH" />
                                    <asp:BoundField DataField="MaximumDemand" HeaderText="Maximum Demand" SortExpression="MaximumDemand" />
                                    <asp:BoundField DataField="UHICondition" HeaderText="UHI Condition" SortExpression="UHICondition" />
                                    <asp:BoundField DataField="1C-Peak" HeaderText="1C-Peak" SortExpression="1C-Peak" />
                                    <asp:BoundField DataField="2C-Peak" HeaderText="2C-Peak" SortExpression="2C-Peak" />
                                    <asp:BoundField DataField="ReadingTakenBy" HeaderText="Reading Taken By" SortExpression="ReadingTakenBy" />
