<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="WorkflowStatusForLV.aspx.cs" Inherits="app_WorkflowStatusForLV" %>
                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" runat="server" id="employee">
                                            <div class="control-group">
                                                <label>Employee:</label>
                                                <asp:Label ID="txtEmployee" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-6" runat="server" id="responsible">
                                            <div class="control-group">
