<%@ Page Title="Center" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="Center.aspx.cs" Inherits="app_Center" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-lg-6">
                <section class="panel">
                    ...
                    <fieldset>
                        <legend>Create Functional Office</legend>
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddLocationID" Width="100%" runat="server" CssClass="form-control select2me"
                                        AutoPostBack="True" AppendDataBoundItems="false" OnSelectedIndexChanged="ddLocationID_SelectedIndexChanged">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td>Functional Office Name<span class="required">*</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtContactNo" ValidationGroup="Save" runat="server" ErrorMessage="Enter contact no"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtAdress" runat="server" TextMode="MultiLine" Rows="2" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtAdress" ValidationGroup="Save" runat="server" ErrorMessage="Enter address"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                ...
                <section class="panel">
                    <fieldset>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                            ...
                            GridLines="Vertical" DataKeyNames="CenterID" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
                            <Columns>

                                <asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
                                    <ItemTemplate>
                                        <%#Container.DataItemIndex+1 %>.
                                        <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Bind("CenterID") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="20px" HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="Name" HeaderText="Functional Office Name" SortExpression="Name" />
