                    ...
                    <section class="panel">
                        ...
                        <div class="form_container left_label field_set">
                            ...
                            <asp:GridView ID="GridView2" runat="server"  AutoGenerateColumns="False" DataKeyNames="LevelID"
                                OnDataBound="GridView2_DataBound" CssClass="table table-bordered table-striped" AllowSorting="True">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Employee ID" SortExpression="EmployeeInfoID">
                                        <ItemTemplate>
                                            <asp:Label ID="EmployeeInfoID" runat="server" Text='<%# Bind("EmpID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="View" SortExpression="RollNumber">
                                        <ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                SelectCommand="SELECT sl, EmployeeInfoID, IDCardNo, StudentNameE, FatherNameE, RollNumber, PhoneMobile, Section FROM [tblEmployee] WHERE Class=@Class
