<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="WorkflowStatusForSIR.aspx.cs" Inherits="app_WorkflowStatusForSIR" %>
                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <label>Date of SIR:</label>
                                                <asp:Label ID="txtDateofSIR" runat="server"></asp:Label>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <label>SIR Voucher No:</label>
                                                <asp:Label ID="txtSirNumber" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <label>Loan To Employee:</label>
                                                <asp:Label ID="txtEmployee" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                            <div class="control-group">
                                                <label>Product Using Purpose:</label>
                                                <asp:Label ID="txtProductPurpose" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
