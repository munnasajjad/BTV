<%@ Page Title="Live Broadcasting" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="LiveBroadcasting.aspx.cs" Inherits="app_LiveBroadcasting" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-lg-6">
                <section class="panel">
                    ...
                    <fieldset>
                        <legend>Live Broadcasting</legend>
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:Label ID="lblMsg" runat="server" EnableViewState="false"></asp:Label>
                                    <asp:Label ID="lblId" Visible="false" runat="server" Text=""></asp:Label>
                                    <asp:HiddenField runat="server" ID="hiddenLBID" />
                                    <asp:HiddenField runat="server" ID="hiddenLBVoucher" />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtSerialNo" ValidationGroup="Save" runat="server" ErrorMessage="Enter Serial"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtDate" ValidationGroup="Save" runat="server" ErrorMessage="Enter date"></asp:RequiredFieldValidator>
                                </td>
                            </tr>

                            <tr>
                                <td>LB Number<span class="required">*</span></td>
                                <td>
                                    <asp:TextBox ID="txtLBNumber" ReadOnly="True" runat="server" CssClass="form-control"></asp:TextBox>

                                </td>
                            </tr>

                            <tr>
                                <td>Live Program Place<span class="required">*</span></td>
                                <td>
                                    <asp:TextBox ID="txtVenue" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtVenue" ValidationGroup="Save" runat="server" ErrorMessage="Enter Venue"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>Proposed Starting Time<span class="required">*</span></td>
                                <td>
                                    <asp:TextBox ID="txtProposedStartingTime" runat="server" TextMode="Time" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtProposedStartingTime" ValidationGroup="Save" runat="server" ErrorMessage="Enter Proposed Time"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>Staring Time<span class="required">*</span></td>
                                <td>
                                    <asp:TextBox ID="txtStaringTime" TextMode="Time" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtStaringTime" ValidationGroup="Save" runat="server" ErrorMessage="Enter Starting Time"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>Ending Time<span class="required">*</span></td>
                                <td>
                                    <asp:TextBox ID="txtEndingTime" TextMode="Time" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtEndingTime" ValidationGroup="Save" runat="server" ErrorMessage="Enter Ending Time"></asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td>Transmission Medium<span class="required">*</span></td>
                                <td>
                                    <asp:TextBox ID="txtSource" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtSource" ValidationGroup="Save" runat="server" ErrorMessage="Enter Transmission Medium"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Active Source</td>
                                <td>
                                    <asp:DropDownList ID="ddlActiveSource" Width="100%" CssClass="form-control select2me" runat="server">
                                        <%--<asp:ListItem>DSNG-C Band</asp:ListItem>
                                        <asp:ListItem>DSNG-ku Band</asp:ListItem>
                                        <asp:ListItem>Satellite Backpack</asp:ListItem>
                                        <asp:ListItem>Microwave</asp:ListItem>
                                        <asp:ListItem>Fiber Optics BTCL</asp:ListItem>
                                        <asp:ListItem>Fiber Optics Private</asp:ListItem>
                                        <asp:ListItem>Others Source</asp:ListItem>--%>
                                    </asp:DropDownList>
                                    <%--<asp:TextBox ID="txtActiveSource" runat="server" CssClass="form-control"></asp:TextBox>--%>
                                </td>
                            </tr>


                            <tr>
                                <td>Stand By Source</td>
                                <td>
                                    <asp:DropDownList ID="ddlStandBySource" Width="100%" CssClass="form-control select2me" runat="server">
                                        <%--<asp:ListItem>DSNG-C Band</asp:ListItem>
                                        <asp:ListItem>DSNG-ku Band</asp:ListItem>
                                        <asp:ListItem>Satellite Backpack</asp:ListItem>
                                        <asp:ListItem>Microwave</asp:ListItem>
                                    ...
                                    <%--<asp:TextBox ID="txtStandBySource" runat="server" CssClass="form-control"></asp:TextBox>--%>
                                </td>
                            </tr>


                            <tr>
                                <td>Responsible Person<span class="required">*</span></td>
                                <td>
                                    <asp:TextBox ID="txtResponsiblePerson" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtResponsiblePerson" ValidationGroup="Save" runat="server" ErrorMessage="Enter Name"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtContactNumber" ValidationGroup="Save" runat="server" ErrorMessage="Enter Contact Number"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <%--<tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtShiftInCharge" ValidationGroup="Save" runat="server" ErrorMessage="Enter Shift Incharge"></asp:RequiredFieldValidator>
                                </td>
                            </tr>--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtRemarks" ValidationGroup="Save" runat="server" ErrorMessage="Enter Remarks"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>Shift Incharge<span class="required">*</span></td>
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="ddShiftInCharge" InitialValue="0" ValidationGroup="Save" runat="server" ErrorMessage="Enter Shift Incharge"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                    ...
                    <fieldset>
                        ...
                        <div class="table-responsive">
                            <asp:GridView Width="280%" ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                                ...
                                GridLines="Vertical" DataKeyNames="LiveBroadcastingId" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>.
                                            <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Bind("LiveBroadcastingId") %>'></asp:Label>
                                            <asp:Label ID="lblEntryBy" runat="server" Visible="false" Text='<%# Bind("EntryBy") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="20px" HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="LB Number" SortExpression="LBVoucher">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" Width="120px" Target="_blank" NavigateUrl='<%#Eval("LiveBroadcastingId") %>'>
                                                <asp:Label ID="lblLBNumber" runat="server" Text='<%# Bind("LBVoucher") %>'></asp:Label>
                                            </asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Workflow Details">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink" Width="110px" runat="server" Target="_blank" NavigateUrl='<%# "WorkflowStatusForLiveBroadcasting?id="+Eval("LiveBroadcastingId") %>'>
                                    ...
                                    <asp:BoundField DataField="ProposedStartingTime" HeaderText="Proposed Starting Time" SortExpression="ProposedStartingTime" />
                                    <asp:BoundField DataField="StaringTime" HeaderText="Staring Time" SortExpression="StaringTime" />
                                    <asp:BoundField DataField="EndingTime" HeaderText="Ending Time" SortExpression="EndingTime" />
                                    <asp:BoundField DataField="Source" HeaderText="Source" SortExpression="Source" />
                                    <asp:BoundField DataField="ActiveSource" HeaderText="Active Source" SortExpression="ActiveSource" />
                                    <asp:BoundField DataField="StandBySource" HeaderText="Stand By Source" SortExpression="StandBySource" />
                                    <asp:BoundField DataField="ResponsiblePerson" HeaderText="Responsible Person" SortExpression="ResponsiblePerson" />
