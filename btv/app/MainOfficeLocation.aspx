<%@ Page Title="Location Setup For Main Office" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="MainOfficeLocation.aspx.cs" Inherits="app_MainOfficeLocation" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-lg-6">
                <section class="panel">
                    ...
                    <fieldset>
                        <legend>Create Location In Main Office</legend>
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            ...
                            <tr>
                                <td>Location Name<span class="required">*</span></td>
                                <td>
                    ...
                    <fieldset>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MainOfficeLocationName" HeaderText="Location Name" SortExpression="LocationName" />
