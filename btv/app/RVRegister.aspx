<%@ Page Title="R V Register" Language="C#" MasterPageFile="~/app/MasterPage.Master" AutoEventWireup="true" CodeFile="RVRegister.aspx.cs" Inherits="app_RVRegister" %>
...
<td>R V No</td>
<td>
<asp:TextBox ID="txtRVNo" runat="server" CssClass="form-control"></asp:TextBox>
<asp:FilteredTextBoxExtender ID="ftbRVNo" runat="server" FilterType="Numbers" ValidChars="0123456789" TargetControlID="txtRVNo" />
</td>
</tr>
...
<td>Location I D</td>
<td>
<asp:DropDownList ID="ddLocationID" runat="server" CssClass="form-control select2me"
     AutoPostBack="False" OnSelectedIndexChanged="ddLocationID_SelectedIndexChanged">
</asp:DropDownList>
</td>
</tr>
...
<td>Location From</td>
<td>
<asp:TextBox ID="txtLocationFrom" runat="server" CssClass="form-control"></asp:TextBox>
</td>
</tr>
...
<asp:GridView width="160%" ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE"
    ...
    GridLines="Vertical" DataKeyNames="RVRegID" OnSelectedIndexChanged="GridView1_OnSelectedIndexChanged" OnRowDeleting="GridView1_OnRowDeleting">
<Columns>

<asp:TemplateField HeaderText="#Sl" ItemStyle-Width="20px">
<ItemTemplate>
<%#Container.DataItemIndex+1 %>.
<asp:Label ID="Label1" runat="server" visible="false" Text='<%# Bind("RVRegID") %>'></asp:Label>
</ItemTemplate>
<ItemStyle Width="20px" HorizontalAlign="Center" />
</asp:TemplateField>
<asp:BoundField DataField="RVNo" HeaderText="R V No" SortExpression="RVNo" /><asp:BoundField DataField="LocationID" HeaderText="Location I D" SortExpression="LocationID" /><asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" /><asp:BoundField DataField="ProductDescription" HeaderText="Product Description" SortExpression="ProductDescription" /><asp:BoundField DataField="Condition" HeaderText="Condition" SortExpression="Condition" /><asp:BoundField DataField="LocationFrom" HeaderText="Location From" SortExpression="LocationFrom" /><asp:BoundField DataField="Remarks" HeaderText="Remarks" SortExpression="Remarks" />
