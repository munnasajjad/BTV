<%@ Page Title="Work Flow Status For Dehumidifier" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="WorkFlowStatusForDehumidifier.aspx.cs" Inherits="app_WorkFlowStatusForDehumidifier" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <fieldset>
                            <div class="caption">
                                <legend>Dehumidifier Voucher Information</legend>
                            </div>
                            <div class="portlet-body">
                                ...
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <asp:Label ID="txtDMVoucher" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-4">
