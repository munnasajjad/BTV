<%@ Page Title="MenuStructure" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="MenuStructure.aspx.cs" Inherits="app_MenuStructure" %>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:DropDownList ID="ddFormGroup" runat="server" DataSourceID="SqlDataSource3" 
                                        AutoPostBack="True" OnSelectedIndexChanged="ddFormGroup_OnSelectedIndexChanged" DataTextField="GroupName" DataValueField="GroupName">
                                       </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT Sl, GroupName FROM MenuGroup">
                                        <%--<SelectParameters>
                                     ...
                                     <%--<asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT DISTINCT [MenuGroup] FROM [MenuSubGroup] WHERE ([Show] = @Show) AND (ProjectId = @ProjectId)">
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="1" Name="Show" Type="Int32" />
                                            <asp:SessionParameter DefaultValue="0" Name="ProjectId" SessionField="ProjectID" />
                                        </SelectParameters>
                                ...
                                <div class="control-group hidden">
                                    ...
                                    <asp:DropDownList ID="ddSubGroup" runat="server"
                                        DataSourceID="SqlDataSource2" DataTextField="FormName" DataValueField="sl" AutoPostBack="True" OnSelectedIndexChanged="ddSubGroup_OnSelectedIndexChanged">
                                        
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT [sl], [FormName] FROM [MenuStructure] WHERE ([Show] =1) AND [MenuGroup]=@MenuGroup AND (ProjectId = @ProjectId)">
                                        <SelectParameters>
                                    ...
                                    <%--<asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT [sl], [MenuSubGroup] FROM [MenuSubGroup] WHERE ([Show] =1) AND [MenuGroup]=@MenuGroup AND (ProjectId = @ProjectId)">
                                        <SelectParameters>
                                            <asp:ControlParameter Name="MenuGroup" ControlID="ddFormGroup" PropertyName="SelectedValue" />
                                            <asp:SessionParameter DefaultValue="0" Name="ProjectId" SessionField="ProjectID" />
                                        </SelectParameters>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:TextBox ID="txtPriority" runat="server" Width="35%" Text="1" ></asp:TextBox>
                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Show" HeaderText="Active" SortExpression="UserLevel" />
                                    ...
                                    <EmptyDataTemplate>
                                        <p>The Menu group has no submenu!</p>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT SL, MenuGroup,  FormName, PageName, HTMLControlID, Priority, Show FROM [MenuStructure] WHERE MenuGroup=@MenuGroup ORDER BY [Priority]"
                                ...
                                <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT SL, MenuGroup, (Select MenuSubGroup from MenuSubGroup where sl=MenuStructure.MenuSubGroup) as MenuSubGroup,  FormName, PageName, HTMLControlID, Priority, Show FROM [MenuStructure] where  MenuGroup=@MenuGroup AND (ProjectId = @ProjectId) ORDER BY [FormName]"
                                    DeleteCommand="delete Logins where lid=0">
                                    <SelectParameters>
                                        <asp:ControlParameter Name="MenuGroup" ControlID="ddFormGroup" PropertyName="SelectedValue" />
                                        <asp:SessionParameter DefaultValue="0" Name="ProjectId" SessionField="ProjectID" />
